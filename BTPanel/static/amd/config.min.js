...
define(["require", "exports", "./snabbdom", "./public/public"], function (require, exports, snabbdom_1, public_1) {
	...
	var Config = (function (_super) {
																											...
																											switch (_b.label) {
																													...
																													case 3:
																															...
																															return [4, that.$confirm({
																																			title: "\u5173\u95ED\u9762\u677FSSL",
																																			msg: "\u5173\u95ED\u9762\u677FSSL\u8BC1\u4E66".concat(that.configInfo.ssl_verify
			...
			Config.prototype.setAlarmView = function (config) {
					return __awaiter(this, void 0, void 0, function () {
							var channelInfo, email, feishu, weixin, dingding, sms, isChannel, error_15;
							var _this = this;
							return __generator(this, function (_a) {
									switch (_a.label) {
											case 0:
													...
													isChannel = !(email && email.receive) &&
															!(feishu && feishu.feishu_url) &&
																	...
																	success: function () { return __awaiter(_this, void 0, void 0, function () {
																			...
																			return __generator(this, function (_b) {
																					switch (_b.label) {
																							...
																							case 1:
																									_a = _b.sent(), channelRes = _a[0], alarmRes = _a[1];
																									init = function () {
																											var map = {
																													mail: { id: 'mail_alarm' },
																													dingding: { id: 'dingding_alarm' },
																													feishu: { id: 'feishu_alarm' },
																													weixin: { id: 'weixin_alarm' },
																											};
																											var msg = alarmRes.msg;
																											if (msg) {
																													var id = map[msg].id;
																													$("#".concat(id)).prop('checked', true);
																											}
																											var dKey = '';
																											for (var key in channelRes) {
																													var item = channelRes[key];
																											...
																											if (dKey) {
																													var id = map[dKey].id;
																													var $tit = $("#".concat(id)).parent().prev();
																													$tit.text($tit.text() + '（默认）');
																											}
																									};
																									init();
																									...
																									$('#mail_alarm,#dingding_alarm,#feishu_alarm,#weixin_alarm').on('click', function (ev) { return __awaiter(_this, void 0, void 0, function () {
			...
			Config.prototype.eventBind = function () {
					return __awaiter(this, void 0, void 0, function () {
							...
							return __generator(this, function (_a) {
									...
									$('.login-alarm-line').on('click', '.setAlarmMail, .setAlarmMailBtn', function () {
