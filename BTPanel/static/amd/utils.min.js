	...
	var Public = (function (_super) {
			...
			Public.prototype.renderLoginAlarmLine = function (config) {
					...
					if (isChannel && login_alarm_info) {
							...
							$('.login-alarm-line .line-row').html('<a href="javascript:;" class="btlink setAlarmMail">' +
									map[login_alarm_info] +
									'已配置</a>');
					}
					else {
							$('.login-alarm-line .line-row').html('<a href="javascript:;" class="bt_warning setAlarmMail">邮箱未配置</a> <span class="interval">&nbsp;&nbsp;|&nbsp;&nbsp;</span> <a href="javascript:;" class="bt_warning setAlarmMail">钉钉/飞书/企业微信未配置</a>');
					}
			};
			return Public;
	}(utils_1.default));
